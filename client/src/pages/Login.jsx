...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      const googleReturnUrl = localStorage.getItem("google_auth_return_to");
      const returnUrl =
        googleReturnUrl || localStorage.getItem("returnTo") || "/dashboard";
      // Clean up both storage items
      localStorage.removeItem("returnTo");
      localStorage.removeItem("google_auth_return_to");
      navigate(returnUrl);
    }
  }, [navigate]);
  ...
  const handleGoogleLogin = () => {
    const currentReturnTo = localStorage.getItem("returnTo");
    if (currentReturnTo) {
